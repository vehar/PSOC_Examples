...
static uint8 bigSource[TOTAL_SIZE] __attribute__((aligned(32)));
static uint8 smallDest[CHUNK_SIZE * 3] __attribute__((aligned(32)));
...
{
    CyDmaTdSetAddress(td, LO16(srcAddr), LO16((uint32)(smallDest)));
}
